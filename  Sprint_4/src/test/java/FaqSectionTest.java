...
@RunWith(Parameterized.class)
    public class FaqSectionTest {
        ...
        private final String expandedLineNumber;
        private final String result;

        public FaqSectionTest(String number, String expandedLineNumber, String result) {
            this.number = number;
            this.expandedLineNumber = expandedLineNumber;
            this.result = result;
        }

        // Тестовые данные
        @Parameterized.Parameters
        public static Object[][] checkTextInExpandFaq() {
            return new Object[][]{
    ...
    public void checkFaqSection() {
        ...
        FaqSection objFaqSection = new FaqSection(driver);
        objFaqSection.scrollToFaq();
        objFaqSection.clickOnFaqLine(number);
        assertEquals (result, objFaqSection.getTextOnExpandedFaq(expandedLineNumber));
    }
